...
# Security: simple bearer check so only your GPT Action can call it
...
DEFAULT_LANGS = ["sv-SE","nb-NO","da-DK","de-DE","fr-FR","it-IT","es-ES","nl-NL","zh-Hans","zh-Hant","ja-JP","ko-KR"]
...
async def translate_vtt(
    ...
    # Ensure the translator script is present
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        # Run translator
        cmd = ["python", translator_path, src_path, "--langs", *langs_list, "--model", model, "--wrap", str(wrap)]
        try:
